  ...
  return (
    <div className="overlay">
      <div className="confirmationBox">
        ...
        <p>Cette action est irréversible et entraînera la suppression définitive de "<strong>{demoTitle}</strong>".</p>
        <div className="buttons">
          <button onClick={onCancel} className="cancelButton">Annuler</button>
          <button onClick={onConfirm} className="confirmButton">Supprimer</button>
        </div>
      </div>
    </div>
  );
